...
export const MacbookScroll = ({ src, showGradient, title, badge }) => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[125vh] md:min-h-[200vh]  flex flex-col items-center py-0 md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.53] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="text-white text-3xl font-bold mb-10 md:mb-14 text-center"
      >
        {title || (
          <span className="">
